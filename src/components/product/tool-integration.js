...
import bg from '../../assets/images/product/integration-tools/background.svg';

import { font1, font3, font6, fontSize18, lineHeight29 } from '../../assets/globalStyles';
...
export default function ToolIntegration() {
    return (
        <BG>
            ...
            <SubText>
                {
                    'Enjoy the ease of setting up and running your CI/CD\npipelines with both Git providers.'
                }
            </SubText>
